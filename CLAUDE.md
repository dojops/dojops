...
pnpm test               # Vitest across all packages (834 tests)
...
- Dev tooling — Vitest (834 tests), ESLint, Prettier, Husky + lint-staged, per-package tsconfig.json
